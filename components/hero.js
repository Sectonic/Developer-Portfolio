...
function Hero({ pageLoad, setPageLoad, children }) {
  ...
  return (
    <div style={{ height: heroHeight }} >
      <div className="absolute inset-0 bg-slate-950 mb-1 w-full" ref={heroRef}>
          <motion.div
          ...
          { pageLoad && (
            <div className="w-full absolute text-center -translate-x-1/2 -translate-y-1/2 max-[1000px]:top-[52.5%] left-1/2 top-[45%]">
              { children }
            </div>
          ) }
