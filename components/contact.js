...
const ContactForm = () => {
    ...
    return (
        <form className="mt-10 lg:mt-20 max-md:px-10 md:w-[500px] h-[430px] md:h-[410px] overflow-hidden m-auto flex flex-col justify-start items-end gap-3" onSubmit={formSubmit} ref={ref}>
            <AnimatePresence>
