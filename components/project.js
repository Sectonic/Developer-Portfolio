...
const Project = ({ src, title, tags, github, live, children, delay = 0 }) => {
    ...
    return (
        ...
        >
            <Link href={live} target="_blank" rel="noopener noreferrer" className="block cursor-pointer relative w-full md:h-[350px] xl:h-[292px] 2xl:h-[350px] rounded-lg overflow-hidden">
