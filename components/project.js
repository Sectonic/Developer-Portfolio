        ...
        >
            ...
            <div className="relative -mt-[40px] md:-mt-[60px] ml-5 w-full md:h-[145px] bg-gray-900 z-20 rounded-lg p-4">
                ...
                <div className="mt-3 flex flex-wrap justify-start items-start gap-2">
                    { tags.map(tag => (
                        <div className="transition bg-slate-700 group-hover:bg-blue-500 text-slate-200 group-hover:text-slate-100 px-2 rounded-full text-sm font-medium">{tag}</div>
                    )) }
                </div>
            </div>
        </motion.div>
